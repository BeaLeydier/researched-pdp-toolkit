...
do "$root/0_scripts/2.2.Section2-Analysis-AllPathways.do"

do "$root/0_scripts/2.3.Section2-Analysis-ShortTerm.do"
...
/* Insert notes/explanations on updating the readme. */
