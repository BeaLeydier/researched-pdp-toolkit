...
This toolkit was created to help you use Postsecondary Data Partnership (PDP) Analysis Ready (AR) files to understand patterns of success among CTE students. A major advantage of this toolkit is that it leverages the fact that the AR files are standardized, making it very easy for you to adapt the toolkit's code to your own institution and produce your own reports easily by plugging the toolkit's code into your own PDP data. Moreover, the PDP AR files contain a lot of student outcomes that are likely not compiled anywhere else in your institution - for example, short term outcomes after one year - and this toolkit shows you how to analyze this data and make the most of it.

By using this toolkit, you'll be able to understand what CTE pathways generate which student outcomes, what courses are critical to student's success, and how these dynamics vary by demographic and other student characteristics.
...
The goal of this toolkit is to replicate the [CTE Diagnostics Toolkit](https://github.com/rachworsham/open_sdp_cte_toolkit) generated by the [Strategic Data Project](https://opensdp.github.io/) using your institution's PDP [Analysis-Ready Files](https://help.studentclearinghouse.org/pdp/knowledge-base/using-the-analysis-ready-file.s/). It uses Stata to transform and analyze the data, and generates tables and figures for your analysis. Given this toolkit was developed as an extension of the [CTE Diagnostics Toolkit](https://github.com/rachworsham/open_sdp_cte_toolkit), we recommend that you read the CTE Diagnostic Narrative and Technical Guide prior to completing the analysis.
